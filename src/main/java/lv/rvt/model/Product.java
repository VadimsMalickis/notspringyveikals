...
public class Product{
    ...
    public String toString(){
        ...
        return String.format("%4s", ID) + "|" +  String.format("%20s", name) + "|" + String.format("%11s", type) + "|" + String.format("%7.2f", price) + "   [" + selected +"] " + TextColor.RED.getValue() +  outOfStock + TextColor.ANSI_RESET.getValue();
    }
